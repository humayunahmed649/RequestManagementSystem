namespace RMS.Models.Migrations
{
    ...
    public partial class District_Seeds : DbMigration
    {
        public override void Up()
        {
            ...
            INSERT[dbo].[Districts] ([Id], [DivisionId], [Name], [BnName], [Lat], [Lon], [Website]) VALUES(18, 5, N'Bogura', N'বগুড়া', 24.8465228, 89.377755, N'www.bogra.gov.bd')
            ...
            INSERT[dbo].[Districts] ([Id], [DivisionId], [Name], [BnName], [Lat], [Lon], [Website]) VALUES(43, 2, N'Chattogram', N'চট্টগ্রাম', 22.335109, 91.834073, N'www.chittagong.gov.bd')
            INSERT[dbo].[Districts] ([Id], [DivisionId], [Name], [BnName], [Lat], [Lon], [Website]) VALUES(44, 2, N'Cumilla', N'কুমিল্লা', 23.4682747, 91.1788135, N'www.comilla.gov.bd')
